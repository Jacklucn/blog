        ...
        <span class="post-time">
          2017-08-31
            ...
            <div class="post-content">
                ...
                <blockquote>
                    <p>题图是现在的壁纸 <a href="https://alpha.wallhaven.cc/wallpaper/456973" target="_blank" rel="noopener">Code
                            Geass</a> （没错，就是反叛的鲁鲁修中的 Code Geass）</p>
                </blockquote>
                <p>昨天乱搞把电脑搞炸了，然后又误操作把系统格掉了。悲剧.. 除了在 Github 上的代码其他什么东西都没有了，心疼收集了那么久的电子书..</p>
                <p>然后只能重装系统了，想想也好.. 是时候清理清理电脑了，正好借着这个机会整理一下。一开始使用简直烦到不行。没有安装罗技的鼠标驱动，鼠标按键无法打开
                    Launchpad，虽然可以用键盘快捷键，还是觉得很不舒服。还有一个很重点的是没有 Alfred，简直变得生活不能自理了。然后还有很多好用的工具要重新安装，找原先的 iTerm2 配色找了半天..
                    所以说论备份的重要性..</p>
                <a id="more"></a>
                ...
                <p>除了这些 App 还有非常重要的东西要安装：iTerm2 + zsh + oh my zsh，接着把 Neovim 装上下载之前的配置，调整 iTerm2 的配色（现在用的是这个 <a
                            href="https://github.com/w0ng/vim-hybrid" target="_blank" rel="noopener">vim-hybrid</a>，主要是配合
                    Vim 的配色），现在可以美滋滋的写代码了～</p>
